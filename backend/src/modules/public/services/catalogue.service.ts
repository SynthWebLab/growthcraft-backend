...
export class CatalogueService {
  ...
  private mapCourseToCatalogueItem(course: ICourse): CatalogueItem {
    return {
      ...
      isDateTBA: Boolean(course.isDateTBA),
  ...
  private mapBootcampToCatalogueItem(bootcamp: IBootcamp): CatalogueItem {
    ...
    return {
      ...
      tags: bootcamp.tags,
      startDate: bootcamp.startDate ? bootcamp.startDate.toISOString() : null,
      endDate: bootcamp.endDate ? bootcamp.endDate.toISOString() : null,
      isDateTBA: Boolean(bootcamp.isDateTBA),
      mode: bootcamp.mode,
