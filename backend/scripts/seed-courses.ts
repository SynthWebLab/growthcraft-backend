...
const sampleCourses = [
  ...
  },
  {
    ...
    description: 'Master Docker, Kubernetes, CI/CD pipelines, and cloud infrastructure automation',
    category: 'DevOps',
    difficultyLevel: 'Intermediate',
    duration: 75,
    lessonsCount: 48,
  ...
  },
  {
    ...
    description: 'Deep dive into generics, decorators, advanced types, and building type-safe applications',
    category: 'MERN',
    difficultyLevel: 'Advanced',
    duration: 45,
    lessonsCount: 32,
  ...
  },
  {
    ...
    description: 'Complete ML course covering supervised, unsupervised learning, neural networks, and deployment',
    category: 'DataScience',
    difficultyLevel: 'Advanced',
    duration: 130,
    lessonsCount: 95,
  ...
  },
  {
    ...
    description: '16-week intensive bootcamp covering HTML, CSS, JavaScript, React, Node.js, and deployment',
    category: 'MERN',
    difficultyLevel: 'Beginner',
    duration: 640,
    lessonsCount: 160,
    ...
    tags: ['Bootcamp', 'Full-Stack', 'React', 'Node.js', 'Career Support'],
    enrollmentCount: 45,
    isActive: true,
    isDraft: false,
    ...
    bootcampDetails: {
      totalSeats: 50,
      availableSeats: 5,
      startDate: new Date('2024-03-01'), // Future start
      endDate: new Date('2024-06-30'),
      registrationDeadline: new Date('2024-02-25'),
    },
  },
  {
    title: 'Data Science Bootcamp - Batch 2',
    slug: 'data-science-bootcamp-batch-2',
    description: '12-week intensive program with live projects, mentorship, and job placement assistance',
    category: 'DataScience',
    difficultyLevel: 'Intermediate',
    duration: 480,
    lessonsCount: 120,
    ...
    tags: ['Bootcamp', 'Data Science', 'Python', 'ML', 'Job Support'],
    enrollmentCount: 30,
    isActive: true,
    isDraft: false,
    publishedAt: new Date('2024-01-01'),
  ...
  },
  {
    ...
    description: '10-week hands-on bootcamp covering Docker, Kubernetes, AWS, and CI/CD pipelines',
    category: 'DevOps',
    difficultyLevel: 'Advanced',
    duration: 400,
    lessonsCount: 100,
    ...
    tags: ['Bootcamp', 'DevOps', 'Kubernetes', 'AWS', 'Career Track'],
    enrollmentCount: 18,
    isActive: true,
    isDraft: false,
    ...
    bootcampDetails: {
      totalSeats: 25,
      availableSeats: 7,
      startDate: new Date('2024-01-15'), // Already started
