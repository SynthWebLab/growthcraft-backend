...
const DUMMY_BOOTCAMPS: Bootcamp[] = [
  {
    ...
    description:
      "Become a professional full-stack developer in 16 weeks. Master React, Node.js, MongoDB, and deploy production-ready applications.",
    duration: "16 weeks",
    ...
    instructor_bio:
      "Senior Full Stack Developer with 10+ years of experience at top tech companies. Built and scaled applications serving millions of users.",
    is_published: true,
    is_featured: true,
  ...
  },
  {
    ...
    description:
      "Transform into a data scientist with hands-on training in Python, Machine Learning, Deep Learning, and AI. Work on real industry projects.",
    duration: "20 weeks",
    ...
    instructor_bio:
      "PhD in Machine Learning, Data Scientist at Fortune 500 company. Published researcher with 15+ papers in AI conferences.",
    is_published: true,
    is_featured: true,
  ...
  },
  {
    ...
    description:
      "Master DevOps practices and cloud technologies. Learn AWS, Docker, Kubernetes, CI/CD, and infrastructure automation.",
    duration: "14 weeks",
    format: "Online + Live Sessions",
    batch_size: 20,
    price: 44999,
    ...
    instructor_bio:
      "AWS Certified Solutions Architect & DevOps Engineer. 12+ years building scalable cloud infrastructure for startups and enterprises.",
    is_published: true,
    is_featured: false,
  ...
  },
  {
    ...
    description:
      "Build professional iOS and Android apps with React Native. Learn mobile UI/UX, state management, and app deployment.",
    duration: "12 weeks",
    format: "Online + Live Sessions",
    batch_size: 25,
    price: 39999,
    ...
    instructor_bio:
      "Mobile Developer with 8+ years of experience. Published 50+ apps with millions of downloads on App Store and Play Store.",
    is_published: true,
    is_featured: false,
...
export const useBootcamps = () => {
  ...
  const fetchBootcamps = async () => {
    ...
    try {
      ...
      const publishedBootcamps = DUMMY_BOOTCAMPS.filter(
        (bootcamp) => bootcamp.is_published,
      ).sort((a, b) => {
